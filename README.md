#  **<span style="color:green">ACADA Learning, Alberta, Canada.</span>**
...
$ source ~/.bashrc  
# run the scripts https://github.com/acadalearning/eks-terraform-setup/blob/main/terraform-install.sh
